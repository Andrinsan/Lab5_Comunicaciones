...
class Lab5_p3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PWM", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab5_p3")
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 10*fm, 2*A, -A+offset, 0)
    ...
    def set_offset(self, offset):
        self.offset = offset
        self.analog_sig_source_x_1.set_offset(-self.A+self.offset)
    ...
    def set_fm(self, fm):
        ...
        self.analog_sig_source_x_1.set_frequency(10*self.fm)
...
def main(top_block_cls=Lab5_p3, options=None):
